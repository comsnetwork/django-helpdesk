    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=helpdesk.models.attachment_path, verbose_name='File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empty_selection_list', models.BooleanField(help_text='Only for List: adds an empty first entry to the choices list, which enforces that the user makes an active choice.', verbose_name='Add empty first choice to List?')),
                ...
                ('required', models.BooleanField(help_text='Does the user have to enter a value for this field?', verbose_name='Required?')),
                ('staff_only', models.BooleanField(help_text='If this is ticked, then the public submission form will NOT show this field', verbose_name='Staff Only?')),
            ],
        ),
        migrations.CreateModel(
            name='EmailTemplate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateTimeField(default=datetime.datetime(2016, 9, 6, 15, 43, 6, 863759), verbose_name='Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_view', models.BooleanField(help_text='Can this CC login to view the ticket details?', verbose_name='Can View Ticket?')),
                ('can_update', models.BooleanField(help_text='Can this CC login and update the ticket?', verbose_name='Can Update Ticket?')),
